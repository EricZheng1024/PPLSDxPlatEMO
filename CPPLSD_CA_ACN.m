function [A0_new, norm_scope, log_rho, n_restart] = CPPLSD_CA_ACN(problem, A0, L, K, rho_init, drho, L_ACN, tp, maxRuntime, strict_same, type_restart)
% 带有约束的PPLS/D-C&A算法
